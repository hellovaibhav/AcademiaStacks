...
const Assignment = () => {
  ...
  const fetchAssignments = async () => {
    setLoading(true);
    try {
      const response = await axios.get(API_ENDPOINTS.ASSIGNMENTS);
            ...
            <div className="flex-1 px-4 md:px-8 pb-10">
              ...
              <div className="mt-8 flex justify-center">
                {index < data.length - 1 ? (
                  ...
                  >
                    <p className="text-gray-500 text-lg mb-4">🎉 You've seen all assignments!</p>
      ...
      {loading && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white p-6 rounded-lg">
            ...
            <p className="text-center mt-4 text-gray-600">Loading assignments...</p>
          </div>
        </div>
      )}
    </>
