...
const Notes = () => {
  ...
  return (
    <>
      {
        <div className="min-h-[100vh] bg-[#F3EFE0] flex items-center justify-center pt-[5rem] md:pt-28 pl-[15%] sm:pl-[25%] lg:pl-[25rem] md:pl-[20%] xl:pl-[30rem]  ">
          <div className="leftFilter fixed top-[15vh] left-14 hidden md:block w-[20vw]">
            <div className="flex text-white h-80 flex-col items-center py-2 justify-center rounded-xl px-4 xl:px-10 2xl:px-20 lg:px-6 bg-[rgb(34,163,159,0.4)]">
